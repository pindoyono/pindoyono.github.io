...
larstart/resources/views/layouts/master.blade.php
@pindoyono pindoyono 27jan20
5f08eb8 4 days ago
168 lines (147 sloc)  5.11 KB
...
<head>
  ...
  <link rel="stylesheet" href="/larstart/public/css/app.css">
</head>
...
<div class="wrapper" id="app">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="public/img/logo.png" alt="LaraStart Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
...
<!-- REQUIRED SCRIPTS -->
<script src="/larstart/public/js/app.js"></script>
</body>
</html>
